    ...
    return (
        <>
            <div className="signinPage">
                <div className="signinLeftPanel">
                    <div className="signinLeftContent">
                        ...
                        <div className="metricCard">
                            <div className="metricCardLeft">
                                <div className="svgOuterCircle">
                                    <svg
                                        width="20"
                                        height="20"
                                        viewBox="0 0 25 25"
                            ...
                            <div className="metricCardRight">
                                <div
                                    className="incrementValue"
                                    style={{ color: "rgba(0, 73, 198, 1)" }}
                                >
                                    <h5> ↑ 14%</h5>
                                </div>
                                <div
                                    className="incrementDuration"
                                    style={{ marginTop: "3px" }}
                                >
                ...
                <div className="signinRightPanel">
                    <div className="signinRightContent">
                        <div className="rightContentTitle">
                            ...
                            <h1 style={{ fontWeight: "300" }}> CodeAnt AI </h1>
                        </div>
                        <h1>Welcome to CodeAnt AI</h1>
                        <div className="signinTabs">
                            <button
